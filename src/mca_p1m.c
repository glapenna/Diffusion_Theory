...
init_mca_p1()
{
	...
	dptr->idunion.mca_p1.m1 = 3;
	dptr->idunion.mca_p1.m2 = 0;
...
/* get id */
        ...
        if (mptr->id_type != MCARIG)
                inerr("setup_mca_p1: mcarig id expected\n","");
        gettok();
        ...
        dptr->idunion.mca_p1.m1=mptr->idunion.mcarig.nf;
        dptr->idunion.mca_p1.m2=0;
        ...
        for(;;) {
         if(tok[0]==';') {
          ...
          gettok();
          tokint(&dptr->idunion.mca_p1.m2,tok);
          dptr->idunion.mca_p1.type=2;
          gettok();
        ...
        dptr->idunion.mca_p1.mca = mptr;
        dptr->idunion.mca_p1.bead = bptr;

        dptr->idunion.mca_p1.n0=dptr->idunion.mca_p1.m1
                               +dptr->idunion.mca_p1.m2;
        dptr->idunion.mca_p1.n1=dptr->idunion.mca_p1.n0;
        dptr->idunion.mca_p1.n123=dptr->idunion.mca_p1.m1*
                                 dptr->idunion.mca_p1.m1*
         (dptr->idunion.mca_p1.m1+1)/2;

        dptr->idunion.mca_p1.dim1=
         dptr->idunion.mca_p1.n1*(dptr->idunion.mca_p1.n1+1)/2;
        dptr->idunion.mca_p1.dim12=
         dptr->idunion.mca_p1.n1*dptr->idunion.mca_p1.n123;
        dptr->idunion.mca_p1.dim2=
         dptr->idunion.mca_p1.n123*(dptr->idunion.mca_p1.n123+1)/2;

        dptr->idunion.mca_p1.s1 = (_REAL *)
          get2(dptr->idunion.mca_p1.dim1,sizeof(_REAL));
        dptr->idunion.mca_p1.f1 = (_REAL *)
          get2(dptr->idunion.mca_p1.dim1,sizeof(_REAL));
        for(i=0;i<dptr->idunion.mca_p1.dim1;i++) {
         *dptr->idunion.mca_p1.s1++ =0.;
         *dptr->idunion.mca_p1.f1++ =0.;
        }
        ...
        dptr->idunion.mca_p1.s12 = (_REAL *)
          get2(dptr->idunion.mca_p1.dim12,sizeof(_REAL));
        dptr->idunion.mca_p1.f12 = (_REAL *)
          get2(dptr->idunion.mca_p1.dim12,sizeof(_REAL));
        for(i=0;i<dptr->idunion.mca_p1.dim12;i++) {
         *dptr->idunion.mca_p1.s12++ =0.;
         *dptr->idunion.mca_p1.f12++ =0.;
        }
        dptr->idunion.mca_p1.s12-=dptr->idunion.mca_p1.dim12;
        dptr->idunion.mca_p1.f12-=dptr->idunion.mca_p1.dim12;

        dptr->idunion.mca_p1.s2 = (_REAL *)
          get2(dptr->idunion.mca_p1.dim2,sizeof(_REAL));
        dptr->idunion.mca_p1.f2 = (_REAL *)
          get2(dptr->idunion.mca_p1.dim2,sizeof(_REAL));
        for(i=0;i<dptr->idunion.mca_p1.dim2;i++) {
         *dptr->idunion.mca_p1.s2++ =0.;
         *dptr->idunion.mca_p1.f2++ =0.;
        }
        ...
        dptr->idunion.mca_p1.m = (modstruct *)
          get2(dptr->idunion.mca_p1.n0,sizeof(modstruct));
        ...
        dptr->idunion.mca_p1.Fm = rot_matrix
         (0,dptr->idunion.mca_p1.n0-1,0,dptr->idunion.mca_p1.n0-1);

        printf("setup_mca_p1: n0:    %d\n",dptr->idunion.mca_p1.n0);
        printf("setup_mca_p1: n1:    %d\n",dptr->idunion.mca_p1.n1);
        printf("setup_mca_p1: n123:  %d\n",dptr->idunion.mca_p1.n123);
        printf("setup_mca_p1: dim1:  %d\n",dptr->idunion.mca_p1.dim1);
        printf("setup_mca_p1: dim12: %d\n",dptr->idunion.mca_p1.dim12);
        printf("setup_mca_p1: dim2:  %d\n",dptr->idunion.mca_p1.dim2);
}
...
do_first_p1(idstruct *objptr,idstruct *serptr)
{
   ...
   idstruct *bptr,*mptr;
   int i1,i2,i3,j1_0,j2_0,j3_0,j1,j2,j3,
   ...
   for (i1=0,p1=p;i1<nmode1;i1++,p1++) {
    for (i2=0,p2=p;i2<nmode1;i2++,p2++) {
     for (i3=i2,p3=p2;i3<nmode1;i3++,p3++) {
...
#include "fbb.c"
   ...
   p=objptr->idunion.mca_p1.m;
   for (i1=0,p1=p,kk=0;i1<nmode;i1++,p1++) {
    for (j1=i1,p2=p1;j1<nmode;j1++,p2++) {
